...
# Condition: single-turn, precise rule statement, prior word うみ
...
print(f"Running {N_TRIALS} trials (Natural Precise, prior word: うみ)...\n")
...
filename = f"claude_natural_precise_umi_n{N_TRIALS}_{timestamp}.csv"
